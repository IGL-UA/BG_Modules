/*
 	Name: BG_fn_InitModuleArtyleryMapTools
...
if(_activated) then {
	...
	if (ACE_player in synchronizedObjects _logic) then {		
/* 			{ */
	        _this spawn {
				...
				}] ;
				{
					...
					["Курвимітер",{
						...
						_EH = _map ctrlAddEventHandler ["Draw",{
							...
							_map drawIcon [
								"#(rgb,1,1,1)color(0,0,0,0)",[1,1,1,1],_drawPos,0,0,0,"ЛКМ додати точку, ПКМ - закрити",2,0.06,"PuristaMedium","left"
							] ;
						}] ;
						...
						_EH = _map ctrlAddEventHandler ["Draw",{
							...
							_map drawIcon [
								"#(rgb,1,1,1)color(0,0,0,0)",[1,1,1,1],_drawPos,0,0,0,(_dir toFixed 2) + " ("+ (switch round (_dir/45) do {				//Mils added here
									case 1: {"Північний Схід"};
									case 2: {"Схід"};
									case 3: {"Південний Схід"};
									case 4: {"Південь"};
									case 5: {"Південний Захід"};
									case 6: {"Захід"};
									case 7: {"Північний Захід"};
									default {"Північ"};
							...
							_map drawIcon [
								"#(rgb,1,1,1)color(0,0,0,0)",[1,1,1,1],_drawPos,0,0,0,"ПКМ - закрити",2,0.06,"PuristaMedium","left"
							] ;
					...
					["Рельєф",{
						...
						_EH = _map ctrlAddEventHandler ["Draw",{
							...
							_map drawIcon [
								"#(rgb,1,1,1)color(0,0,0,0)",[1,1,1,1],_drawPos,0,0,0,["ЛКМ - підтвердити, ПКМ - закрити","ПКМ - закрити"] select !isNil {uiNamespace getVariable ["PLP_MapTools_Height_curPos",nil]},
